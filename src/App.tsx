...
const COMPANIES = [
  ...
  },
  {
    ...
    projects:[
      ...
      { name:"RL Project (Russell Lake JV)", stage:"Active Drilling", ownership:"80% (Denison 20%)", grade:"Drill target", resource:"TBD", depth:"TBD" },
      { name:"Getty East (Russell Lake JV)", stage:"Planned Drilling", ownership:"Operator", grade:"TBD", resource:"TBD", depth:"TBD" },
      { name:"Falcon Point / South Falcon East", stage:"Partner Funded", ownership:"50%", grade:"TBD", resource:"TBD", depth:"TBD" },
    ],
...
const BASIN_PROJECTS = [
  ...
  { name:"Moore Lake",      company:"Skyharbour Res.",    ticker:"SYH",   lat:57.467, lng:-104.883, stage:"Explorer", grade:"~6% U₃O₈ (zones)", gradePct:6.0, resourceMlb:null, drilling:true,  type:"Unconformity",     info:"Skyharbour's 100%-owned flagship — Maverick Zone high-grade intercepts. Plus South Falcon East & Preston Lake partner-funded JVs." },
  { name:"RL Project",      company:"Skyharbour Res.",    ticker:"SYH",   lat:57.62, lng:-105.02, stage:"Explorer", grade:"Drill target", gradePct:null, resourceMlb:null, drilling:true,  type:"Unconformity",     info:"53,192 ha within the Russell Lake JV — Skyharbour 80% & operator, Denison 20%. 2026 drilling at South Russell & Kowalchuk targets, adjacent to Moore Lake and east of Denison's Wheeler River." },
