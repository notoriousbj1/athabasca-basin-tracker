...
const BASIN_PROJECTS = [
  ...
  { name:"Christie Lake",    company:"Uranium Energy",     ticker:"UEC",   lat:57.92, lng:-103.55, stage:"Explorer", grade:"~1–2% U₃O₈ (hist.)", gradePct:1.5, resourceMlb:null, drilling:false, type:"Unconformity",       info:"Former UEX asset (Christie Lake / Horseshoe-Raven). Coordinates approximate." },
  { name:"NW Athabasca JV",  company:"Forum Energy",       ticker:"FMC",   lat:59.30, lng:-109.05, stage:"Explorer", grade:"Drill target",  gradePct:null, resourceMlb:null, drilling:false, type:"Unconformity",       info:"Northwest Athabasca + Janet/Fir Island projects. Coordinates approximate." },
  { name:"Murmac / Strike",  company:"Fortune Bay",        ticker:"FOR",   lat:59.42, lng:-108.70, stage:"Explorer", grade:"Drill target",  gradePct:null, resourceMlb:null, drilling:false, type:"Basement-hosted",    info:"Murmac & Strike projects, far north near Uranium City. Coordinates approximate." },
  { name:"Gibbons Creek",    company:"ALX Resources",      ticker:"AL",    lat:58.35, lng:-108.85, stage:"Explorer", grade:"Drill target",  gradePct:null, resourceMlb:null, drilling:false, type:"Basement-hosted",    info:"Gibbons Creek / Black Lake-area portfolio, western basin. Coordinates approximate." },
  { name:"Loranger",         company:"Appia",              ticker:"API",   lat:58.42, lng:-103.95, stage:"Explorer", grade:"Drill target",  gradePct:null, resourceMlb:null, drilling:false, type:"Unconformity",       info:"Loranger uranium project, eastern basin (also Alces Lake REE). Coordinates approximate." },
    ...
    <div style={S.root}>
      ...
      <div style={{ display:"flex", alignItems:"flex-start" }}>
        ...
        <aside style={{
          ...
          {/* U₃O₈ Spot price — only when expanded */}
          {sidebarOpen && (
            <div style={{ marginTop:"auto", padding:"16px", borderTop:"1px solid #E2DCD0" }}>
              <div style={{ ...S.lbl, marginBottom:6 }}>U₃O₈ Spot (USD / lb)</div>
              <div style={{ fontSize:28, fontWeight:900, color:"#B07A08", ...MONO, letterSpacing:"-1px", lineHeight:1 }}>
                {spotLoading ? "—" : `$${spot.price?.toFixed(2)}`}
              </div>
              <div style={{ fontSize:11, color:spotWoW>=0?"#1A7A44":"#C01818", marginTop:4, fontWeight:700 }}>
                {spotWoW>=0?"▲":"▼"} {Math.abs(spotWoW).toFixed(2)} WoW
              </div>
              <div style={{ display:"flex", alignItems:"center", gap:6, marginTop:10, fontSize:11, ...MONO }}>
              ...
              <div style={{ fontSize:9, color:"#9A9A8A", marginTop:8, letterSpacing:"0.04em" }}>
                {new Date().toLocaleDateString("en-CA",{ dateStyle:"medium" })}
              </div>
            </div>
          )}
        </aside>
