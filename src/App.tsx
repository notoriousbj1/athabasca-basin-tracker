...
const COMPANIES = [
  ...
  },
  {
    ...
    exchange:"TSXV / OTCQB", price:0.34, changePct:6.25, marketCap:"42M",
...
const STATIC_GLOBAL_NEWS = [
  { headline:"China Approves 10 New Nuclear Reactors in Single Announcement, Largest Single-Year Commitment in History", publication:"World Nuclear News", category:"New Builds", date:"Jun 9, 2025", url:"https://www.world-nuclear-news.org/", summary:"China's State Council approved construction of 10 new reactors across five sites, adding approximately 11 GW of capacity and cementing the country's dominance in nuclear expansion." },
  { headline:"US Senate Passes ADVANCE Act Companion Bill, Streamlining NRC Licensing Timelines by Up to 50%", publication:"Reuters", category:"Policy", date:"Jun 7, 2025", url:"https://www.reuters.com/business/energy/", summary:"Bipartisan legislation clears procedural hurdles, directing the NRC to overhaul its review process for advanced reactor designs and significantly cut approval timelines." },
  { headline:"Global Nuclear Investment Hits Record $65 Billion in 2025 as Utilities Race to Secure Low-Carbon Baseload", publication:"Bloomberg", category:"Market", date:"Jun 6, 2025", url:"https://www.bloomberg.com/energy", summary:"New data from BloombergNEF shows nuclear capital deployment has surpassed solar for the first time in a decade, driven by AI datacenter demand and net-zero commitments." },
  { headline:"EU Taxonomy Formally Confirms Nuclear as Green Investment — Trillion-Dollar ESG Capital Pool Opens", publication:"Financial Times", category:"Policy", date:"Jun 5, 2025", url:"https://www.ft.com/energy", summary:"The European Commission's taxonomy delegated act locks in nuclear's sustainable label, potentially unlocking institutional capital previously blocked by ESG mandates." },
  { headline:"Uranium Spot Price Forecast: Analysts See Supply Deficit Widening Through 2028 as Reactor Pipeline Grows", publication:"S&P Global", category:"Market", date:"Jun 4, 2025", url:"https://www.spglobal.com/commodityinsights/", summary:"A new S&P Commodity Insights report projects the uranium market will face a structural deficit of 25–35 Mlb annually by 2027, supporting a multi-year price floor above $75/lb." },
  { headline:"India Sanctions Six New Pressurised Heavy Water Reactors, Targeting 20 GW Nuclear by 2032", publication:"Nuclear Engineering International", category:"New Builds", date:"Jun 3, 2025", url:"https://www.neimagazine.com/", summary:"India's Cabinet Committee on Economic Affairs approved the country's most ambitious nuclear expansion in three decades, with construction to begin at two sites in 2026." },
  { headline:"Westinghouse AP1000 Secures Three-Country Framework Agreement Across Eastern Europe — 12 Units Targeted", publication:"World Nuclear News", category:"New Builds", date:"Jun 1, 2025", url:"https://www.world-nuclear-news.org/", summary:"Poland, Czech Republic, and Estonia signed a joint procurement framework with Westinghouse, standardising on the AP1000 design and sharing procurement costs across 12 planned units." },
  { headline:"30 Nations Reaffirm COP28 Nuclear Pledge — Tripling Global Capacity to 2,200 GW by 2050 on Track", publication:"AP News", category:"Policy", date:"May 30, 2025", url:"https://apnews.com/hub/nuclear", summary:"A mid-year review of COP28 signatories shows 27 of 30 nations have initiated formal policy frameworks, with the IAEA reporting the pledge is currently ahead of its 2030 interim milestones." },
  { headline:"Small Modular Reactor Race Heats Up: NuScale, GE Hitachi, and Rolls-Royce All Hit Key Milestones in May", publication:"Mining.com", category:"Technology", date:"May 28, 2025", url:"https://www.mining.com/uranium", summary:"Three leading SMR developers reported concurrent regulatory and commercial milestones last month — NuScale's VOYGR received a customer term sheet, GE Hitachi's BWRX-300 broke ground in Ontario, and Rolls-Royce completed UK Generic Design Assessment Phase 2." },
  { headline:"AI Datacenters Fuel Nuclear Renaissance — Tech Giants Signing Long-Term Power Purchase Agreements", publication:"The Guardian", category:"Market", date:"May 26, 2025", url:"https://www.theguardian.com/environment/nuclear-power", summary:"Microsoft, Google, Amazon, and Meta have collectively committed to over 8 GW of nuclear offtake agreements since 2024, with analysts crediting AI electricity demand as the dominant near-term driver of new reactor financing." },
];
...
export default function App() {
  ...
  const fetchGlobalNews = useCallback(async () => {
    ...
    try {
      const raw = await aiSearch(
        `Search for the latest global nuclear energy news from the past 14 days. Find articles from major publications (Reuters, Bloomberg, World Nuclear News, Nuclear Engineering International, Financial Times, AP, BBC, S&P Global, Uranium Insider, etc.) covering: new reactor construction announcements, nuclear energy policy, uranium supply/demand, nuclear technology, government nuclear programs, and nuclear finance. For each article find the real URL. Return ONLY a JSON array (8-10 items, no markdown): [{"headline":"...","publication":"Reuters","date":"2025-06-08","url":"https://...","summary":"...","category":"New Builds"}]`,
        "Return ONLY a valid JSON array with no markdown. Include real URLs to actual published articles."
      );
      try { const a=JSON.parse(raw.replace(/```json|```/g,"").trim()); if(Array.isArray(a)) setGlobalNews(a); } catch {}
    } catch {}
    setGNL(false);
  }, []);
